...
/**
 * Loads markdown files from .freecode/output-styles directories throughout the project
 * and from ~/.freecode/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .freecode/output-styles/*.md -> project styles
 * - User ~/.freecode/output-styles/*.md -> user styles (overridden by project styles)
 *
