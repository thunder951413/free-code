 ...
 *
 * This module is responsible for discovering, loading, and validating Free Code plugins
...
export async function cachePlugin(
  ...
  const manifestPath = join(tempPath, '.freecode-plugin', 'plugin.json')
 ...
 * @param source - Source description for default manifest (e.g., "git:repo" or ".freecode-plugin/name")
 ...
 * @param source - Source identifier (e.g., "git:repo", ".freecode-plugin/my-plugin")
...
export async function createPluginFromPath(
  ...
  const manifestPath = join(pluginPath, '.freecode-plugin', 'plugin.json')
  ...
  const plugin: LoadedPlugin = {
    ...
    source, // Source identifier (e.g., "git:repo" or ".freecode-plugin/name")
 ...
 * - After modifying .freecode-plugin/ directory (for export)
