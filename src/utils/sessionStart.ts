  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .freecode/settings.json'
      } else {
        userGuidance =
      ...
      // from .freecode/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
