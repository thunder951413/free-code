 ...
 * overridden by a user's ~/.freecode/settings.json — e.g. a Bedrock setup for
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'ANTHROPIC_DEFAULT_Ds_MODEL',
  'ANTHROPIC_DEFAULT_Ds_MODEL_DESCRIPTION',
  'ANTHROPIC_DEFAULT_Ds_MODEL_NAME',
  'ANTHROPIC_DEFAULT_Ds_MODEL_SUPPORTED_CAPABILITIES',
 ...
 * These are Free Code specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'VERTEX_REGION_CLAUDE_4_0_Ds',
  'VERTEX_REGION_CLAUDE_4_0_SONNET',
  'VERTEX_REGION_CLAUDE_4_1_Ds',
