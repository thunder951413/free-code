  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.freecode/agent-memory/<agentType>/, 'project' - .freecode/agent-memory/<agentType>/, 'local' - .freecode/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.freecode/settings.json). " +
        "'project' - Project settings (.freecode/settings.json). " +
        "'local' - Local settings (.freecode/settings.local.json).",
    ),
)
