/**
 * Main entrypoint for Free Code Agent SDK types.
 *
...
/**
 * A scheduled task from `<dir>/.freecode/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.freecode/scheduled_tasks.json` and yield events as tasks fire.
 *
